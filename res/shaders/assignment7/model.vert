...
void main(){
	...
	//TODO normal_matrix / surface_normal / vectors model.vert
	...
	vec4 lp = view_matrix * vec4(light_position, 1.0);
	to_light_vector = (lp.xyz - position_in_viewspace).xyz;
